<template>
	<div class="operation">
         ...
         <a href="javascript:;" @click="backto" class="go_back icon iconfont icon-fanhui"></a>   快递分析
      </div>
         		<div class="courier-body">
         		  <div class="courier-body-top-information">
         			<div class="position-name">
         				<span>{{title}}</span>
         				<!-- <img src="../../../static/images/icon_arrow.png"> -->
         			</div>
         			<div class="data-class">
         				<!--<span>2017.08.02-2017.09.02</span>-->
         				<input class="date-style" type="text" @click="openByDialog" :value="calendar4.display" readonly>
         				<img src="../../../static/images/icon_arrow.png">
         			</div>
         		  </div>
                     ...
                     >
         				<li v-for="(item,index) in list" :key="index">
         					...
         					<span>{{item.name}}</span>
         					<em>{{item.express_in_num}}件</em>
         					<p>{{item.status == "1"?"正常":item.status =="0"?"关闭":"异常"  || color }}</p>
         				</li>
                        <li v-show='moreData' style="text-align:center;height:35px;line-height:35px">无更多数据</li>  
         			</ul>
...
.go_back{
   ...
   left: 5px;
	...
	.courier-title{
		...
		color:#3e3e3e;
		text-align: center;
		background: url('../../../static/images/common_nav_btn_menu_n.png');
	...
	.position-name{
		background: url('../../../static/images/icon_dz.png');
		background-repeat: no-repeat;
