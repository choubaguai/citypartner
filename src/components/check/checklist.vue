          ...
          <div class="shop_content">
              <ul>
                <li v-for="(item,index) in list" :key="index" >
                 ...
                 county_name:item.county_name,doorheadurl:item.doorheadurl,headimgurl:item.headimgurl,
                 id:item.id,invite_code:item.invite_code,mobi:item.mobi,name:item.name,step:item.step,}}" >
                      <table>
                        <tr>
                            <td style="width:8%">
